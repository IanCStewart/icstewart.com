...
type SEOQuery = { readonly site: { readonly siteMetadata: { readonly titleTemplate: string | null, readonly defaultTitle: string | null, readonly defaultDescription: string | null, readonly siteUrl: string | null, readonly defaultImage: string | null } | null } | null };
